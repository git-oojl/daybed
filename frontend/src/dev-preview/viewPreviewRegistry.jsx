import { accessGroups, canViewerAccess, getPreviewViewer, previewViewers } from '../auth/viewerAccess.js'
...
export function getPreviewLayout(layoutId) {
  return previewLayouts.find((layout) => layout.id === layoutId) ?? previewLayouts[0]
}
