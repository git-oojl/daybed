function BusinessMetricsPage() {
  return (
    <main>
      ...
      <section aria-labelledby="metricas-del-negocio-total-de-pedidos">
        <h2 id="metricas-del-negocio-total-de-pedidos">Total de pedidos</h2>
      </section>
      <section aria-labelledby="metricas-del-negocio-ventas-simuladas">
        <h2 id="metricas-del-negocio-ventas-simuladas">Ventas simuladas</h2>
      </section>
      <section aria-labelledby="metricas-del-negocio-pedidos-por-estado">
