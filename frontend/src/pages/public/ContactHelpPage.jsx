function ContactHelpPage() {
  return (
    <main>
      ...
      <section aria-labelledby="contacto--ayuda-preguntas-frecuentes">
        <h2 id="contacto--ayuda-preguntas-frecuentes">Preguntas frecuentes</h2>
      </section>
      <section aria-labelledby="contacto--ayuda-formulario-de-ayuda">
