      ...
      <main className="orders-main">
        ...
        {filteredOrders.length === 0 ? (
          <div className="orders-empty">
            <p className="orders-empty__message">No se encontraron pedidos para "{searchTerm}"</p>
            <button 
                        ...
                        <td colSpan="6">
                          <div className="orders-detail-box">
                            <div className="orders-detail-grid">
                              ...
                              <div className="orders-detail-section">
                                <h4 className="orders-detail__header">Informacion</h4>
                                <div className="orders-detail__content">
                                  <div className="orders-detail__item">
                                    <span className="orders-detail__label">Numero de pedido</span>
                                    <span className="orders-detail__value">{order.id}</span>
                                  </div>
                                  <div className="orders-detail__item">
                                    <span className="orders-detail__label">Cliente</span>
                                    <span className="orders-detail__value">{order.customer}</span>
                                  </div>
                                  <div className="orders-detail__item">
                                  ...
                                  <div className="orders-detail__item">
                                    <span className="orders-detail__label">Direccion de entrega</span>
